...
for path_pri,path_tra,file_identifier in zip(path_pri_files,path_tra_files,file_identifier_list): 
    ...
    spectrum_energy0_75 = [0]*(int((len(hits_channel2_df))))
    spectrum_energy75_150 = [0]*(int((len(hits_channel2_df))))
    spectrum_energy150_300 = [0]*(int((len(hits_channel2_df))))
    spectrum_energy300_475 = [0]*(int((len(hits_channel2_df))))
    #%%
    ...
    # hits_channel2_df['spectrum_energy0_75'] = spectrum_energy0_75
    # hits_channel2_df['spectrum_energy75_150'] = spectrum_energy75_150
    # hits_channel2_df['spectrum_energy150_300'] = spectrum_energy150_300
    # hits_channel2_df['spectrum_energy300_475'] = spectrum_energy300_475
    ...
    filename = r"C:\Users\Martin-PC\Biocomposite_analysis_isndcm\classical_features_VALLEN_lambda_w7_cb_" + str(num_coef) + '_' + file_identifier + name +'.pkl'
    pd.to_pickle(hits_channel2_df, filename)
    hits_channel2_df.to_excel(r"C:\Users\Martin-PC\Biocomposite_analysis_isndcm\classical_features_VALLEN_lambda_w7_cb_" + str(num_coef) + '_' + file_identifier + name +'.xlsx')
