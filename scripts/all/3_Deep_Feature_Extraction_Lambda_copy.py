...
save_dir = save_dir_root + '\lambda_cwtms_bio_cfe_gfe_v3_retrained' +  ver_str + '.h5'
...
save_dir = save_dir_root + '\lambda_cwtms_bio_cfe_gfe_v3_retrained_32_64_82_256_6_15_128' + '.h5'
...
save_dir = save_dir_root + '\merged_features_embedded_classical_rho_lambda_cfe_tok' +  ver_str + '.pkl'
pd.to_pickle(merged_features_embedded_classical, save_dir)
save_dir = save_dir_root + '\merged_features_embedded_classical_rho_lambda_cfe_tok' +  ver_str + '.xlsx'
