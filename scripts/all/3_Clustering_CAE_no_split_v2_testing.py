...
def autoencoderConv2D_1(input_shape= (40,432)):
    ...
    layers_depths=[32, 16, 256, 4] #nujno bottleneck = stevilo clustrov
    ...
    conv_1_1 = Conv2D(layers_depths[0], (3,3), activation = 'relu', padding = "SAME", strides=(1, 3))(inputs_1)
    pool_1_1 = MaxPooling2D(pool_size = (2,2), strides = 2)(conv_1_1)
    conv_1_2 = Conv2D(layers_depths[1], (3,3), activation = 'relu', padding = "SAME", strides=(1, 3))(pool_1_1)
    ...
    dec_upsampling_3_1 = UpSampling2D((2, 2))(conv_latent_2)
    dec_tconv_3_1 = Conv2DTranspose(layers_depths[1], (3,3), activation = 'relu', padding = "SAME", strides=(1, 3))(dec_upsampling_3_1)
    dec_upsampling_3_2 = UpSampling2D((2, 2))(dec_tconv_3_1)
    output_1 = Conv2DTranspose(1, (3,3), activation = 'relu', padding = "SAME", strides=(1, 3))(dec_upsampling_3_2)
