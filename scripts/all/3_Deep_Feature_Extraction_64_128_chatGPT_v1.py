...
def autoencoderConv2D_1(input_shape= (128,256),
                        layers_depths=[30, 30, 512, 6, 256, 128],
    ...
    dense_latent_bottleneck = Dense(layers_depths[3], activation = 'relu')(dropout_latent_2)
    ...
    dense_latent_c = Dense(layers_depths[2], activation = 'relu')(clustering_layer)
...
save_dir = save_dir_root + '\Clustering_CAE_isndcm_seperate_decoder_chatGPT_32x64_{filename}_v4'.format(filename=filename) +  ver_str + '.h5'
...
save_dir = save_dir_root + '\\Clustering_CAE_isndcm_seperate_decoder_chatGPT_32x64_45-02s-11_v3_36_36_16_512_6_100_32' + '.h5'
