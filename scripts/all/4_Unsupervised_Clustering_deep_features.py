...
# deep_features_to_keep = [3,5,8,17,23,24,25] # FMXA and deep
deep_features_to_keep = [3,5,8,18] # FMXA and deep
...
for z_axis in ['Log Energy in Signal','amplitude','rise_time']:
    fig_3d = px.scatter_3d(hits_channel1_df_labels, x='Time of Event', y='label_unsupervised', z=z_axis,
                           ...
                           size='Log Energy in Signal', size_max=14, opacity=1,color='label_unsupervised',color_discrete_map={'Cluster 1':viridis_cols[0],'Cluster 2':viridis_cols[1],'Cluster 3':viridis_cols[2],'Cluster 4':viridis_cols[3]})
...
mean_features_df['Cluster'] = ['Cluster 1','Cluster 2','Cluster 3','Cluster 4']
