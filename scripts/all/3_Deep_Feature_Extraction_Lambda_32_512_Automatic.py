...
def autoencoderConv2D_1(input_shape= (32,512)):
    ...
    stride_pool_w = 8
    max_pool_filter_h = 2
    max_pool_filter_w = 8 #16 ALI 8 ali 4
    ...
    dense_latent_bottleneck = Dense(layers_depths[3], activation = 'relu')(dense_latent_1)
    # dense_latent_4 = Dense(layers_depths[2], activation = 'relu')(dense_latent_bottleneck)
    dense_latent_5 = Dense(dense_num, activation = 'relu')(dense_latent_bottleneck)
...
save_dir = save_dir_root + '\isndcm_lambda_32x512_{filename}_v2'.format(filename=filename) +  ver_str + '.h5'
...
save_dir = save_dir_root + '\\lambda_cwtms_bio_cfe_gfe_zeta_lower_rev_w4_32x512_v1_16_32_14_256_6_100_128' + '.h5'
...
save_dir = save_dir_root + '\merged_features_lambda{ver_str}_{filename}_32x512'.format(filename=filename,ver_str=ver_str) +  ver_str + '.pkl'
...
# merged_features_embedded_classical = merged_features_embedded_classical.drop(merged_features_embedded_classical[merged_features_embedded_classical.FMXA_ch1 < 0.1].index)
save_dir_root = r'C:\Users\Martin-PC\Biocomposite_analysis_isndcm'
save_dir = save_dir_root + '\merged_features_lambda_embedded_classical_w7_{filename}_32x512'.format(filename=filename) +  ver_str + '.pkl'
pd.to_pickle(merged_features_embedded_classical, save_dir)
# save_dir = save_dir_root + '\merged_features_embedded_classical_rho20_lambda_cfe_cold' +  ver_str + '.xlsx'
# merged_features_embedded_classical.to_excel(save_dir, index = False) 
