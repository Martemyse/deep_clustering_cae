...
save_dir = save_dir_root + '\Clustering_CAE_isndcm_seperate_decoder_{identifier}_{filename}_v4'.format(filename=filename,identifier=identifier) +  ver_str + '.h5'
...
# save_dir = save_dir_root + f'\\Clustering_CAE_isndcm_seperate_decoder_{identifier}_45-02s-11_v3_36_36_16_512_6_100_32' + '.h5'
# save_dir = save_dir_root + '\\Clustering_CAE_encoder_clustering_chatGPT_32x64_5_clusters_all_files_v5_36_36_16_512_6_10_32' + '.h5'
...
x_pure_pred_enc = encoder.predict(x1_training_input_batch)
...
ver_str = "_" + str(layers_depths[0]) + "_" + str(layers_depths[1]) + "_" + str(layer_depth_latent_cnn) + "_" + str(layers_depths[2]) + "_" + str(layers_depths[3]) + "_" + str(train_epochs) + "_" + str(batch_size)
save_dir_root = r'C:\Users\Martin-PC\Biocomposite_analysis_isndcm\Clustering_CAE'
save_dir = save_dir_root + '\Clustering_CAE_encoder_clustering_{identifier}_6_clusters_{filename}_v2'.format(filename=filename,identifier=identifier) +  ver_str + '.h5'
...
# merged_features_embedded_classical = merged_features_embedded_classical.drop(merged_features_embedded_classical[merged_features_embedded_classical.FMXA_ch1 < 0.1].index)
save_dir_root = r'C:\Users\Martin-PC\Biocomposite_analysis_isndcm'
save_dir = save_dir_root + '\merged_features_encoder_clustering_{identifier}_6_clusters_v1_{filename}_32x64_energy_all'.format(filename=filename,identifier=identifier) +  ver_str + '.pkl'
pd.to_pickle(merged_features_embedded_classical, save_dir)
# save_dir = save_dir_root + '\merged_features_embedded_classical_rho20_lambda_cfe_cold' +  ver_str + '.xlsx'
# merged_features_embedded_classical.to_excel(save_dir, index = False) 
