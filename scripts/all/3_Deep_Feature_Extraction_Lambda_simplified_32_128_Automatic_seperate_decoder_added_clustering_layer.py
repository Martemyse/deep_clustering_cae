...
layers_depths=[16, 32, 1024, 10,512,256]
...
def autoencoderConv2D_1(input_shape= (32,64)):
    ...
    flat_latent_1  = Flatten()(conv_latent_1)
    ...
    dense_latent_4 = Dense(layers_depths[5], activation = 'relu')(dropout_latent_2)
...
save_dir = save_dir_root + '\Clustering_CAE_isndcm_seperate_decoder_lambda_32x64_{filename}_v2'.format(filename=filename) +  ver_str + '.h5'
...
save_dir = save_dir_root + '\\Clustering_CAE_isndcm_seperate_decoder_lambda_32x64_45-02s-13_v2_16_32_12_64_6_30_64' + '.h5'
