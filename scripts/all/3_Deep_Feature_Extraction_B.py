...
#%%
cwtms_ch1_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\Treshold_Trigger_temp_tok\cwtms_ch1_80_288.pkl")
cwtms_ch2_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\Treshold_Trigger_temp_tok\cwtms_ch2_80_288.pkl")
...
x1_training_input_batch = np.concatenate((cwtms_tok,cwtms_t80,cwtms_cfe_gfe),axis=0)
...
save_dir = save_dir_root + '\chi_cwtms_bio_cfe_gfe_v1' +  ver_str + '.h5'
...
save_dir = save_dir_root + '\chi_cwtms_bio_cfe_gfe_v3_retrained_40_80_16_512_6_30_128' + '.h5'
...
classical_features_filtered_hits_ch1_cfe = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\Treshold_Trigger_temp_tok\classical_features_ch1.pkl")
classical_features_filtered_hits_ch2_cfe = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\Treshold_Trigger_temp_tok\classical_features_ch2.pkl")
...
#%% adding classical features CFE @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
x_pure_pred_enc = encoder.predict(cwtms_cfe_input)

classical_features_filtered_hits_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\classical_features_cfe-100_80_288.pkl")
#%% adding classical features GFE @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
x_pure_pred_enc = encoder.predict(cwtms_gfe_input)

classical_features_filtered_hits_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\classical_features_gfe-20_80_288.pkl")
#%%
# number_of_predicted = 8
# start_number = 10000
...
save_dir = save_dir_root + '\merged_features_embedded_classical_gfe_tok' +  ver_str + '.pkl'
pd.to_pickle(merged_features_embedded_classical, save_dir)
save_dir = save_dir_root + '\merged_features_embedded_classical_gfe_tok' +  ver_str + '.xlsx'
