...
def autoencoderConv2D_1(input_shape= (48,512)):
    layers_depths=[32, 64, 512, 16]
    layer_depth_latent_cnn = 32
...
save_dir = save_dir_root + '\lambda_cwtms_bio_cfe_gfe_48x512_v3_32_64_32_512_16_50_20' + '.h5'
