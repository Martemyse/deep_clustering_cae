...
layers_depths=[32, 64, 1024, 24]
layer_depth_latent_cnn = 82
...
def autoencoderConv2D_1(input_shape= (16,1024)):
    layers_depths=[32, 64, 1024, 24]
    layer_depth_latent_cnn = 82
    conv2Dfilters = [(3,3), (3,3)]
    BatchesSliceHeight = 16
    BatchesLength = 512
    stride_pool_h = 2
    stride_pool_w = 4
    max_pool_filter_h = 2
...
#%%
cwtms_bio_cold = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_bio_cold_scaled_16_512.pkl")
cwtms_bio_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_bio_tok_scaled_16_512.pkl")
cwtms_cfe_cold = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_cfe_cold_scaled_16_512.pkl")
cwtms_cfe_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_cfe_tok_scaled_16_512.pkl")
...
# start_number = 1242
# cwtms_cfe_test_validation = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_cfe_tok_scaled_16_512.pkl")

start_number = 23244
cwtms_cfe_test_validation = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_bio_cold_scaled_16_512.pkl")
...
save_dir = save_dir_root + '\lambda_cwtms_bio_cfe_gfe_16x512_v3' +  ver_str + '.h5'
...
save_dir = save_dir_root + '\lambda_cwtms_bio_cfe_gfe_16x512_v2_no_progress_32_64_70_512_24_15_64' + '.h5'
...
classical_features_filtered_hits_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\classical_features_rho_cfe_cold_80_144.pkl")
#%%
columns_vec = []
...
save_dir = save_dir_root + '\merged_features_embedded_classical_rho20_lambda_cfe_cold' +  ver_str + '.pkl'
