...
layers_depths=[32, 64, 512, 10]
layer_depth_latent_cnn = 40
...
def autoencoderConv2D_1(input_shape= (48,256)):
    layers_depths=[32, 64, 512, 10]
    layer_depth_latent_cnn = 40
...
#%%
cwtms_bio_cold = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_zeta_lower_bio_cold_scaled_48_256.pkl")
cwtms_bio_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_zeta_lower_bio_tok_scaled_48_256.pkl")
cwtms_cfe_cold = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_zeta_lower_cfe_cold_scaled_48_256.pkl")
cwtms_cfe_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_zeta_lower_cfe_tok_scaled_48_256.pkl")
...
# start_number = 1242
# cwtms_cfe_test_validation = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_zeta_lower_cfe_tok_scaled_48_256.pkl")

start_number = 23244
cwtms_cfe_test_validation = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_zeta_lower_bio_cold_scaled_48_256.pkl")
...
save_dir = save_dir_root + '\zeta_lower_cwtms_bio_cfe_v1' +  ver_str + '.h5'
...
save_dir = save_dir_root + '\zeta_lower_cwtms_bio_cfe_v1_32_64_40_512_10_3_64' + '.h5'
...
x_pure_pred_enc = encoder.predict(cwtms_cfe_cold)

# classical_features_filtered_hits_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\classical_features_lambda_cfe_cold_80_Infinite_BatchLength.pkl")
classical_features_filtered_hits_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\merged_features_embedded_classical_rho32_lambda_bio_cold_40_80_82_1024_32_35_256.pkl")
# classical_features_filtered_hits_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\merged_features_embedded_classical_rho32_lambda_cfe_cold_40_80_82_1024_32_35_256.pkl")
#%%
columns_vec = []
for i in range(1,layers_depths[3]+1):
    columns_vec.append('Emb_Deep_Lower'+str(i))
...
# save_dir = save_dir_root + '\merged_features_embedded_classical_rho_lambda_cfe_cold_32_64_82_256_6_25_64' +  ver_str + '.pkl'
save_dir = save_dir_root + '\merged_features_embedded_classical_zeta_cfe_cold' +  ver_str + '.pkl'
