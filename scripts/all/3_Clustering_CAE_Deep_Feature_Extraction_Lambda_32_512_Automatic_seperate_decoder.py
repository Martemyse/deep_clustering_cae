...
def autoencoderConv2D_1(input_shape= (32,512)):
    ...
    dropout_1_1 = Dropout(dropout_ratio)(pool_1_2)
    ...
    conv_latent_1 = Conv2D(layer_depth_latent_cnn, ((pool_1_2.get_shape().as_list())[1:][0],(pool_1_2.get_shape().as_list())[1:][1]), activation = 'relu', padding = "SAME", strides=(1, stride_latent_2dconv))(dropout_1_1)
    ...
    dropout_latent_3 = Dropout(dropout_ratio)(dense_latent_bottleneck_input)
    dense_latent_4 = Dense(layers_depths[2], activation = 'relu')(dropout_latent_3)
    dropout_latent_4 = Dropout(dropout_ratio)(dense_latent_4)
    dense_latent_5 = Dense(dense_num, activation = 'relu')(dropout_latent_4)
...
# autoencoder.compile(optimizer='adam', loss='mae') #mse različn način kako se penalizira razlikovanje vhodnega in izhodnega spektograma
autoencoder.compile(optimizer='adam', loss=tf_losses.Huber()) #mse različn način kako se penalizira razlikovanje vhodnega in izhodnega spektograma
#%%
filename = '45-02s-13'
# filename = '45-02s-11'
...
save_dir = save_dir_root + '\isndcm_seperate_decoder_aug_dropout_lambda_32x512_{filename}_v1'.format(filename=filename) +  ver_str + '.h5'
