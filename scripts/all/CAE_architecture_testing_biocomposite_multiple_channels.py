...
layers_depths=[40, 80, 512, 3]
layer_depth_latent_cnn = 82
conv2Dfilters = [(3,3), (3,3)]
BatchesSliceHeight = 64
BatchesLength = 128
stride_pool_h = 2
stride_pool_w = 4
max_pool_filter_h = 2
...
inputs_1 = Input(shape = (BatchesSliceHeight,BatchesLength, 3))
...
inputs_2 = Input(shape = (BatchesSliceHeight,BatchesLength, 3))
...
inputs_3 = Input(shape = (BatchesSliceHeight,BatchesLength, 3))
...
inputs_4 = Input(shape = (BatchesSliceHeight,BatchesLength, 3))
