...
layers_depths=[64, 128, 256, 6]
layer_depth_latent_cnn = 32
...
def autoencoderConv2D_1(input_shape= (32,128)):
    layers_depths=[64, 128, 256, 6]
    layer_depth_latent_cnn = 32
    ...
    conv_1_1 = Conv2D(layers_depths[0], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(split_1)
    pool_1_1 = MaxPooling2D(pool_size = (2,2), strides = 2)(conv_1_1)
    conv_1_2 = Conv2D(layers_depths[1], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(pool_1_1)
    pool_1_2 = MaxPooling2D(pool_size = (2,2), strides = 2)(conv_1_2)

    inputs_2 = Input(shape = (BatchesSliceHeight,BatchesLength, 1))
    conv_2_1 = Conv2D(layers_depths[0], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(split_2)
    pool_2_1 = MaxPooling2D(pool_size = (2,2), strides = 2)(conv_2_1)
    conv_2_2 = Conv2D(layers_depths[1], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(pool_2_1)
    pool_2_2 = MaxPooling2D(pool_size = (2,2), strides = 2)(conv_2_2)

    inputs_3 = Input(shape = (BatchesSliceHeight,BatchesLength, 1))
    conv_3_1 = Conv2D(layers_depths[0], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(split_3)
    pool_3_1 = MaxPooling2D(pool_size = (2,2), strides = 2)(conv_3_1)
    conv_3_2 = Conv2D(layers_depths[1], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(pool_3_1)
    pool_3_2 = MaxPooling2D(pool_size = (2,2), strides = 2)(conv_3_2)

    inputs_4 = Input(shape = (BatchesSliceHeight,BatchesLength, 1))
    conv_4_1 = Conv2D(layers_depths[0], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(split_4)
    pool_4_1 = MaxPooling2D(pool_size = (2,2), strides = 2)(conv_4_1)
    conv_4_2 = Conv2D(layers_depths[1], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(pool_4_1)
    ...
    conv_latent_1 = Conv2D(layer_depth_latent_cnn, (3,3), activation = 'relu', padding = "SAME", strides=(1, stride_latent_2dconv))(concat)
    ...
    conv_latent_2 = Conv2DTranspose(layer_depth_latent_cnn, (3,3), activation = 'relu', padding = "SAME", strides=(1, stride_latent_2dconv))(upsampling_latent_1)
    ...
    dec_tconv_1_1 = Conv2DTranspose(layers_depths[1], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(dec_upsampling_1_1)
    dec_upsampling_1_2 = UpSampling2D((2, 2))(dec_tconv_1_1)
    dec_tconv_1_2 = Conv2DTranspose(1, (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(dec_upsampling_1_2)

    dec_upsampling_2_1 = UpSampling2D((2, 2))(split_2)
    dec_tconv_2_1 = Conv2DTranspose(layers_depths[1], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(dec_upsampling_2_1)
    dec_upsampling_2_2 = UpSampling2D((2, 2))(dec_tconv_2_1)
    dec_tconv_2_2 = Conv2DTranspose(1, (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(dec_upsampling_2_2)

    dec_upsampling_3_1 = UpSampling2D((2, 2))(split_3)
    dec_tconv_3_1 = Conv2DTranspose(layers_depths[1], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(dec_upsampling_3_1)
    dec_upsampling_3_2 = UpSampling2D((2, 2))(dec_tconv_3_1)
    dec_tconv_3_2 = Conv2DTranspose(1, (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(dec_upsampling_3_2)

    dec_upsampling_4_1 = UpSampling2D((2, 2))(split_4)
    dec_tconv_4_1 = Conv2DTranspose(layers_depths[1], (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(dec_upsampling_4_1)
    dec_upsampling_4_2 = UpSampling2D((2, 2))(dec_tconv_4_1)
    dec_tconv_4_2 = Conv2DTranspose(1, (3,5), activation = 'relu', padding = "SAME", strides=(1, stride_norm_2dconv))(dec_upsampling_4_2)
...
#%%
cwtms_bio_cold = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_rho_bio_cold_scaled_32_128.pkl")
cwtms_bio_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_rho_bio_tok_scaled_32_128.pkl")
cwtms_cfe_cold = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_rho_cfe_cold_scaled_32_128.pkl")
cwtms_cfe_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_rho_cfe_tok_scaled_32_128.pkl")
...
autoencoder.compile(optimizer='adam', loss='binary_crossentropy') #mse različn način kako se penalizira razlikovanje vhodnega in izhodnega spektograma
#%%
train_epochs = 50
# batch_size = 64
batch_size = 256
...
# start_number = 23240
# cwtms_cfe_test_validation = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\cwtms_rho_bio_cold_scaled_32_128.pkl")
...
save_dir = save_dir_root + '\crho_cwtms_bio_cfe_gfe_v2_retrained' +  ver_str + '.h5'
...
save_dir = save_dir_root + '\crho_cwtms_bio_cfe_gfe_v2_retrained_64_128_32_256_6_50_256' + '.h5'
...
classical_features_filtered_hits_tok = pd.read_pickle(r"C:\Users\Martin-PC\Biocomposite Analysis\classical_features_rho_cfe_tok_80_144.pkl")
...
save_dir = save_dir_root + '\merged_features_embedded_classical_rho_cfe_tok' +  ver_str + '.pkl'
pd.to_pickle(merged_features_embedded_classical, save_dir)
save_dir = save_dir_root + '\merged_features_embedded_classical_rho_cfe_tok' +  ver_str + '.xlsx'
